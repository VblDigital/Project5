                ...
                <div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><a href="admin-approvecomment-<?= $comment->getId(); ?>">
                            Approuver le commentaire</a></td>
                            <td><a href="admin-deletesubmittedcomment-<?= $comment->getId(); ?>">
                            Supprimer le commentaire</a></td>
                        </tr>
                        </tbody>
                        <?php }
                        }?>
